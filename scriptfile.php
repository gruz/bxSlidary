...
class mod_bxslidaryInstallerScript {
	...
	function preflight($type, $parent) {
		...
		$this->ext_type = (string)$manifest['group'];
		...
		//~ $this->plg_name = $this->_getExtensionName();
		//~ $this->plg_type = (string)$manifest['group'];
		//~ $this->plg_full_name = 'plg_'.$this->plg_type.'_'.$this->plg_name;
		//~ $this->langShortCode = null;//is used for building joomfish links
		//~ $this->default_lang = JComponentHelper::getParams('com_languages')->get('admin');
		//~ $language = JFactory::getLanguage();
	...
	function postflight( $type, $parent ) {
		...
		$this->_publishPlugin($this->plg_name,$this->plg_type, $this->plg_full_name);
